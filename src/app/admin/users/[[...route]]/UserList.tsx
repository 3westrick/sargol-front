...
const UserList = () => {
    ...
    const [paginationModel, setPaginationModel] = React.useState({
      ...
      const user_query = useQuery({
          queryKey: ['admin-users', {query, field, order, limit: paginationModel.pageSize, offset: paginationModel.page * paginationModel.pageSize}],
          queryFn: () => getUsers(query, field, order, paginationModel.pageSize, paginationModel.page * paginationModel.pageSize),
      })
      ...
      const columns: GridColDef[] = [
        ...
        { field: 'is_staff', headerName: 'Is staff', width: 150, type: 'boolean' },
        {
            field: 'actions',headerName: '', sortable:false, width: 150, renderCell: ({id, row, value}) => {
                return <Button onClick={() => router.push(`/admin/users/edit/${id}`)}>Edit</Button>
            },
    ...
    return (
        <>
            <Typography><Link href={'/admin/users/create'}>Create User</Link></Typography>
