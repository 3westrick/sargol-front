...
export default function RolePermissionTransferList() {
    ...
    const permissions_list = watch('permissions')
    ...
    const handleAllRight = () => {
        setValue('permissions', right.concat(left))
        setRight(right.concat(left));
        setLeft([]);
    };

    const handleCheckedRight = () => {
        setValue('permissions', right.concat(leftChecked))
    ...
    const handleCheckedLeft = () => {
        ...
        setValue('permissions', not(right, rightChecked))
